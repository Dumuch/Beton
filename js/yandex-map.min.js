...
(function ymapsInit(e) {
  ...
  t.performance = function (e) {
    ...
    function r() {
      var e = [];
      return i(e, v), i(e, p), e.join(",");
    }

    function i(e, n) {
      for (var t in n) {
        if (n.hasOwnProperty(t) && n[t].length && (e.push(t + "=" + n[t].shift()), e.length >= g)) return;
      }
    }
    ...
    var o,
      ...
      init: function init(e) {
        o = e.url, s = "/pid=443/cid=73188/dtype=stred" + e.data, a = Boolean(e.useSendBeacon && navigator.sendBeacon), u = e.enable, y.initTimings = y.getResourceTimings(e.initUrl), y.saveResourceTimings("initjs", y.initTimings, {
          size: !1,
          cached: !1
        });
      },
      saveMeasure: function saveMeasure(e, t) {
        if (u) {
          var r = /^@/.test(e);
      ...
      startMeasure: function startMeasure(e, n) {
        n = "undefined" == typeof n ? d() : n;
        var t = !1;
        return {
          finish: function finish(r) {
            t || (r = "undefined" == typeof r ? d() : r, y.saveMeasure(e, r - n), t = !0);
          }
        };
      },
    ...
    return window.addEventListener("beforeunload", function () {
      y.saveMeasure("combine.total", y.statistics.combine.total), y.saveMeasure("combine.modules", y.statistics.combine.modules), y.saveMeasure("combine.size", y.statistics.combine.size / 1024), t();
    }), c.exports = y, c.exports;
  }();
  ...
  t.count = function (e) {
    ...
    return function (e) {
      ...
      m.prototype = {
        ...
        _addCallbacks: function _addCallbacks(e, t, r, i, o) {
      ...
      var _ = {
        ...
        allPatiently: function allPatiently(e) {
          return _.allResolved(e).then(function () {
            ...
            for (; u < a;) {
              r = s[u++], i = e[r], _.isRejected(i) ? (n || (n = o ? [] : {}), o ? n.push(i.valueOf()) : n[r] = i.valueOf()) : n || ((t || (t = o ? [] : {}))[r] = _.valueOf(i));
            }
        ...
        _forEach: function _forEach(e, n, t, r, i, o) {
          for (var s = o ? o.length : e.length, a = 0; a < s;) {
            _.when(e[o ? o[a] : a], p(n, a), t, r, i), ++a;
          }
        },
    ...
    return r.nextTick = i.__nextTick__, i.__nextTick__ = void 0, r.isArray = Array.isArray ? Array.isArray : function (e) {
      ...
      for (var i = 0; i < n.length; i++) {
        if (t[i].__expand) r.registerImports(e, t[i].__expand.depends, t[i].__expand.imports);else {
  ...
  o && o.parent && o.parent[o.name] && o.parent[o.name].modules && o.parent[o.name].ready && console.error("(Yandex Maps JS API): api is already enabled on this page with same namespace."), function () {
    function e(e) {
    ...
    function n() {
      ...
      try {
        ...
        t = r.getContext(n = "webgl", i), t || (t = r.getContext(n = "experimental-webgl", i), t || (n = null));
      } catch (o) {
        n = null;
      }
    ...
    t.supports.graphics = {
      ...
      hasWebGl: function hasWebGl() {
        return "webgl" in o || (o.webgl = n()), o.webgl;
      },
    ...
    function r() {
      ...
      n.attachShader(i, t), n.attachShader(i, r), n.bindAttribLocation(i, 0, "p"), n.linkProgram(i);
      var o = n.createBuffer();
      n.bindBuffer(n.ARRAY_BUFFER, o), n.bufferData(n.ARRAY_BUFFER, new Float32Array([0, 0]), n.STATIC_DRAW), n.enableVertexAttribArray(0), n.vertexAttribPointer(0, 2, n.FLOAT, !1, 0, 0), n.clearColor(0, 1, 0, 1), n.clear(n.COLOR_BUFFER_BIT), n.useProgram(i), n.drawArrays(n.POINTS, 0, 1);
    ...
    function i() {
      ...
      return i && (e.vendor = r.getParameter(i.UNMASKED_VENDOR_WEBGL).replace(/\W/g, "_"), e.renderer = r.getParameter(i.UNMASKED_RENDERER_WEBGL).replace(/\W/g, "_")), e;
    }
    ...
    var r = {
      exports: {}
        ...
        i = (r.exports, "Yandex Maps JS API");
    return r.exports = {
  ...
  var s = function (e) {
    ...
    function t(e) {
      this._config = e, this._sandbox = this._config.createSandbox(this), this._definitionsByName = Object.create(null), this._definitionsByStorage = Object.create(null), this._remoteLoadingAllowed = d.defer(), this._initialized = this._remoteLoadingAllowed.promise().then(function () {
        return this._loadBundle(this._config.initialBudleName);
      }, this);
    }

    function r(e, n, t, r, i, o, s, a, u) {
      this.state = e, this.alias = null, this.name = n, this.storage = t, this.key = r, this.depends = i, this.dynamicDepends = a, this.declaration = o, this.context = s, this.exports = e === m.DEFINED ? u : void 0, this.resolvingPromise = void 0, this.fetchingDeferred = void 0;
    }
    ...
    function i(e, n) {
      ...
      for (var r in e.dynamicDepends) {
        if (p.call(e.dynamicDepends, r)) for (var i = 0, o = n.length; i < o; i++) {
          var a = n[i];
    ...
    return l.exports = t, t.prototype.allowRemoteLoading = function () {
      ...
      if (!e.dynamicDepends) {
        if (e.state === m.DEFINED) return d.resolve(e.exports);
        if (e.state === m.ERROR) return d.reject(e.exports);
      }
      ...
      return this._fetchModule(e, n).then(function () {
        ...
        function t(n, t) {
          e.state === m.RESOLVING && (e.state = t ? m.ERROR : m.DEFINED, e.exports = t || n), i && i.resolve(), t && console.warn("ymaps.modules: provide(undefined, error) is deprecated and will be removed, throw instead. Module `" + e.name + "`.");
        }
        ...
        return r ? r : e.state !== m.DEFINED && e.state !== m.ERROR ? (console.warn("ymaps.modules: asynchronous provide is deprecated and will be removed. Module `" + e.name + "`."), i = d.defer(), i.promise()) : void 0;
      }, this);
    }, t.prototype.require = function (e, n, t, r) {
      var i = "object" == _typeof(e) && !f.isArray(e),
  ...
  t.modules = new s({
    ...
    fetchBundle: function fetchBundle(e) {
      ...
      i.src = t.env.bundles.BASE + t.env.bundles[e], i.setAttribute("data-ymaps-api-ns", r), i.setAttribute("data-ymaps-api-version", "2.1.78"), i.async = !0;
      var o = t.vow.defer();
      return i.onerror = o.reject.bind(o), t.ns.__provideBundle = o.resolve.bind(o), document.head.appendChild(i), o.promise().always(function (e) {
        return delete n[r], e;
      });
    },
    ...
    t.ns.modules = {
      ...
      define: function define(e, n, r, i) {
    ...
    function n() {
      l && (t.performance.saveMeasure("ymaps.readyDelay", t.performance.now() - t.performance.initTimings.responseEnd), l = !1);
      ...
      var r = n.require || [],
        ...
        return t.utils.registerImports(t.ns, r, n), e.finish(), t.ns;
      });
    ...
    var o = t.vow,
      ...
      t.utils.registerImports(t.ns, s, e), a.finish(), r(t.env.preload.onLoad, t.ns);
    }, function (e) {
      return r(t.env.preload.onError, e), o.reject(e);
    }),
  ...
  }), t.modules.allowRemoteLoading(), o && (o.parent[o.name] = t.ns), t.performance.init({
  ...
  }), t.env.hasValidApiKey || (t.env.apikey = void 0, "undefined" != typeof t.env.hasValidApiKey && console.warn("(Yandex Maps JS API): Invalid API key")), i.finish();
})({
  "vectorVersion": "5.15.2",
  "vectorVersionTimestamp": 1620030688150,
  "cacheVersion": null,
  "type": "production",
  "flags": [],
  "server": {
  ...
  "layers": {
    "map": {
      "version": "21.05.01-0-b210423152000",
      "scaled": true,
    ...
    "stv": {
      "version": "2021.05.02.18.05-1_21.04.26-0-8683"
    },
    "sta": {
      "version": "2021.05.02.18.05-1_21.04.26-0-8683"
    },
  ...
  "token": "722a474800bdcdf1b9829977500d1e44",
  "distribution": {},
  "version": "2.1.78",
  "majorVersion": "2.1",
  ...
  "bundles": {
    ...
    "BASE": "https://yastatic.net/s3/front-maps-static/maps-front-jsapi-v2-1/2.1.78-11/build"
  }
}, null);