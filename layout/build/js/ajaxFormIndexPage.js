...
var selectItem_modal_light = $('#modal_light').find('.size--select__item');
...
var selectItem_first = $('.size__select--first').find('.size--select__item');
selectItem_first.on('click', function () {
  var chooseItem = $(this).data('value');
  $('#calculate-cost_form').find('input[name="products_select"]').val(chooseItem);
});
var selectItem_second = $('.size__select--second').find('.size--select__item');
...
var selectItem_five = $('.size__select--five').find('.size--select__item');
...
var selectItem_products_footer_form = $('#delivery__products__footer__form').find('.size--select__item');
